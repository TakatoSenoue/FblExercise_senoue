 ...
 *  01.02.00   2024-11-15  vislau  FBL-4366         Perform MISRA 2012 Migration
 **********************************************************************************************************************/

#define SEC_SEEDKEYVENDOR_SOURCE
...
#if ( SECACCESS_HIS_VECTOR_VERSION != 0x0102u ) || \
 ...
 *               SECM_NOT_OK if calculation has failed (e.g. wrong parameters)
 **********************************************************************************************************************/
SecM_StatusType SecM_ComputeKeyVendor( SecM_SeedType inputSeed, SecM_ConstType constant,  /* PRQA S 3673, 3677 */ /* MD_SecSeedKeyVendor_3673, MD_SecSeedKeyVendor_3677 */
...
/* Justification for module-specific MISRA deviations:
  ...
  MD_SecSeedKeyVendor_3677:
     Reason: Const qualifier cannot ne added due to external definition
     Risk: No identifiable risk.
     Prevention: No prevention required.
