 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: .\EcuM.c
 *   Generation Time: 2026-03-05 12:04:39
...
void EcuM_Init(void)
{
  ...
  /* Module: Mcu / InitPhase: INIT_ONE_EARLY */
  Mcu_Init(McuModuleConfiguration);
  Mcu_InitClock(McuConf_McuClockSettingConfig_McuClockSettingConfig);while (MCU_PLL_LOCKED != Mcu_GetPllStatus());Mcu_DistributePllClock();
  /* Module: Port / InitPhase: INIT_ONE_EARLY */
